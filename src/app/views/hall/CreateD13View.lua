...
local CreateD13View = class("CreateD13View", BaseCreateView)

function CreateD13View:ctor(showZFType)
    CreateD13View.super.ctor(self)
...
function CreateD13View:initShowMaskP()
    self.maskP_:show()
end

function CreateD13View:setData(data)
    dump(data,"datadata")
    if not data then
        return
    end
...
function CreateD13View:initShow()
...
function CreateD13View:ren1Handler_()
    self:updateRSList_(1)
end

function CreateD13View:ren2Handler_()
    self:updateRSList_(2)
end

function CreateD13View:ren3Handler_()
    self:updateRSList_(3)
end

function CreateD13View:updateRSList_(index)
...
function CreateD13View:updatejfShowList_(index)
    for i, v in ipairs(self.jfShowList_) do
        v:setVisible(index == i)
    end
end

function CreateD13View:fs1Handler_()
    self:updatefsList_(1)
end

function CreateD13View:fs2Handler_()
    self:updatefsList_(2)
end

function CreateD13View:fs3Handler_()
    self:updatefsList_(3)
end

function CreateD13View:updatefsList_(index)
...
function CreateD13View:jf1Handler_()
    self:updatejfList_(1)
end

function CreateD13View:jf2Handler_()
    self:updatejfList_(2)
end

function CreateD13View:updatejfList_(index)
...
function CreateD13View:mS1Handler_()
    self:updateMSList_(1)
end

function CreateD13View:mS2Handler_()
    self:updateMSList_(2)
end

function CreateD13View:mS3Handler_()
    self:updateMSList_(3)
end

function CreateD13View:mS4Handler_()
    self:updateMSList_(4)
end

function CreateD13View:mS5Handler_()
    self:updateMSList_(5)
end

function CreateD13View:updateMSList_(index)
...
function CreateD13View:jushu1Handler_()
    self:updateJSList_(1)
end

function CreateD13View:jushu2Handler_()
    self:updateJSList_(2)
end

function CreateD13View:jushu3Handler_()
    self:updateJSList_(3)
end

function CreateD13View:updateJSList_(index)
...
function CreateD13View:zhifu1Handler_()
    self:updateZFList_(1)
end

function CreateD13View:zhifu2Handler_()
    self:updateZFList_(2)
end

function CreateD13View:zhifu3Handler_()
    self:updateZFList_(3)
end

function CreateD13View:wenhaoHandler_()
    self.isShowWH_ = not self.isShowWH_
    self.guize_:setVisible(self.isShowWH_)
end

function CreateD13View:updateZFList_(index)
...
function CreateD13View:loaderCsb()
    self.csbNode_ = cc.uiloader:load("views/createRoom/createD13.csb"):addTo(self)
end

function CreateD13View:getRuleInfo()
    local guiZe = {
        ["jushu"] = self.js_,
        ["zhifu"] = self.zf_,
        ["ms"] = self.ms_,
...
function CreateD13View:calcCreateRoomParams(daiKai)
