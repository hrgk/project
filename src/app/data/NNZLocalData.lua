...
local JU_SHU = "NNZ_NIUNIU_JU_SHU"
local REN_SHU = "NNZ_NIUNIU_REN_SHU"
local XIA_ZHU = "NNZ_NIUNIU_XIA_ZHU"
local ZUO_ZHUANG = "NNZ_NIUNIU_ZUO_ZHUANG"
local ZHUANG_BEI_SHU = "NNZ_NIUNIU_ZHUANG_BEI_SHU"
local TE_SHU = "NNZ_NIUNIU_TE_SHU"
local TUI_ZHU = "NNZ_TUI_ZHU"
local JOKER = "NNZ_NIUNIU_JOKER"
local ZHI_FU = "NNZ_NIUNIU_ZHI_FU"
local FAN_BEI_TYPE = "NNZ_NIUNIU_FAN_BEI_TYPE"
local JZCP = "NNZ_NIUNIU_JZCP"
local JZJR = "NNZ_NIUNIU_JZJR"
local PX = "NNZ_NIUNIU_PX"
