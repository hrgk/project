...
local JU_SHU = "BC_NIUNIU_JU_SHU"
local REN_SHU = "BC_NIUNIU_REN_SHU"
local XIA_ZHU = "BC_NIUNIU_XIA_ZHU"
local ZUO_ZHUANG = "BC_NIUNIU_ZUO_ZHUANG"
local ZHUANG_BEI_SHU = "BC_NIUNIU_ZHUANG_BEI_SHU"
local TE_SHU = "BC_NIUNIU_TE_SHU"
local TUI_ZHU = "BC_TUI_ZHU"
local JOKER = "BC_NIUNIU_JOKER"
local ZHI_FU = "BC_NIUNIU_ZHI_FU"
local FAN_BEI_TYPE = "BC_NIUNIU_FAN_BEI_TYPE"
local JZCP = "BC_NIUNIU_JZCP"
local JZJR = "BC_NIUNIU_JZJR"
local PX = "BC_NIUNIU_PX"
