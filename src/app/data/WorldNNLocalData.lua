...
local JU_SHU = "WORLD_NIUNIU_JU_SHU"
local REN_SHU = "WORLD_NIUNIU_REN_SHU"
local XIA_ZHU = "WORLD_NIUNIU_XIA_ZHU"
local ZUO_ZHUANG = "WORLD_NIUNIU_ZUO_ZHUANG"
local ZHUANG_BEI_SHU = "WORLD_NIUNIU_ZHUANG_BEI_SHU"
local TE_SHU = "WORLD_NIUNIU_TE_SHU"
local TUI_ZHU = "WORLD_TUI_ZHU"
local JOKER = "WORLD_NIUNIU_JOKER"
local ZHI_FU = "WORLD_NIUNIU_ZHI_FU"
local FAN_BEI_TYPE = "WORLD_NIUNIU_FAN_BEI_TYPE"
local JZCP = "WORLD_NIUNIU_JZCP"
local JZJR = "WORLD_NIUNIU_JZJR"
local PX = "WORLD_NIUNIU_PX"
