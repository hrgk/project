...
local nodes = {
    type = TYPES.ROOT, children = {
        {type = TYPES.SPRITE, filename = "images/hall.png", x = display.cx, y = display.cy},
        {type = TYPES.SPRITE,var = "fjbg_", filename = "images/sz_bg.png", ppx = 0.5, ppy = 0.5},
        {type = TYPES.SPRITE, filename = "res/images/common/grxx_title.png", ppx = 0.5, ppy = 0.88},
        {type = TYPES.SPRITE, filename = "images/create_room/jiarufanjian.png", ppx = 0.5, ppy = 0.885},
        {type = TYPES.LABEL, options = {text = "请输入房间号", size = 40, font = DEFAULT_FONT, color = cc.c4b(77, 36, 21, 255)} ,ppx = 0.5, ppy = 0.77 ,ap = {0.5,0.5}},
        {type = TYPES.SPRITE, filename = "images/create_room/fj_xk.png", children = {
...
function HallJoinRoomView:caclueButtonBg_(num)
    local buttonSprite = "images/create_room/fj_aj.png"
    if num == 12 then
        buttonSprite = "images/hall/resetnum.png"
    elseif num ==10 then
        buttonSprite = "images/hall/buttonDel.png"
    end
    return buttonSprite
end
