...
local nodes = {
    type = TYPES.ROOT, children = {
        ...
        {type = TYPES.SPRITE, filename = "images/sz_bg.png", x = display.cx, y = display.cy,scale9 = true, size = {1168, 630}, capInsets = cc.rect(100, 100, 100, 100)},
        {type = TYPES.SPRITE, filename = "res/images/common/grxx_title.png", ppx = 0.5, ppy = 0.93},
        {type = TYPES.SPRITE, filename = "images/hall/msg.png", x = display.cx, y = display.top - 50},
