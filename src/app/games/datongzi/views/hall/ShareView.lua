...
local nodes = {
    type = TYPES.ROOT, children = {
        {type = TYPES.LAYER, var = "dialogLayer_", children = {
            {type = TYPES.SPRITE, filename = "images/sz_bg.png", var = "rootLayer_",px = 0.5, py = 0.5 ,ap = {0.5,0.5},scale9 = true, size = {630, 370}, capInsets = cc.rect(100, 100, 100, 100), children = {
...
function ShareView:onButtonWeixinClicked_(event)
    ...
    local params = {
        ...
        url = url or ServerDefense.getBaseURL(),
        inScene = 0,
    }
