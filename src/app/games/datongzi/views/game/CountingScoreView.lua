...
local node = {
    ...
    children = {
        {type = TYPES.NODE, var = "nodeTableInfo_", children = {  -- 桌子信息容器
            {
                type = gailun.TYPES.SPRITE, scale = display.width / DESIGN_WIDTH, filename = "res/images/datongzi/counting_panel/zuoshangjifendi.png", x = display.left + 5, y = display.top - 5, ap = {0, 1},
                children = {
                    {type = gailun.TYPES.SPRITE, filename = "res/images/datongzi/counting_panel/wanjia.png", x = 60, y = 110},
                    ...
                    {type = gailun.TYPES.SPRITE, filename = "res/images/datongzi/counting_panel/lishizongfen.png", x = 175, y = 110},
                    ...
                    {type = gailun.TYPES.SPRITE, filename = "res/images/datongzi/counting_panel/benjufenshu.png", x = 300, y = 110},
                    ...
                    {type = gailun.TYPES.SPRITE, filename = "res/images/datongzi/counting_panel/dizhatongfen.png", x = 425, y = 110},
            ...
            {
                type = gailun.TYPES.SPRITE, scale = display.width / DESIGN_WIDTH, filename = "res/images/datongzi/counting_panel/jifendi.png", x = display.left + display.width / DESIGN_WIDTH * 670, y = display.top - 5, ap = {0.5, 1},
                children = {
                    -- {type = gailun.TYPES.SPRITE, filename = "res/images/datongzi/counting_panel/dangqianpaimianfen.png", x = 100, y = 80},
                    {type = gailun.TYPES.SPRITE, filename = "res/images/datongzi/counting_panel/gongji.png", x = 305, y = 100},
                    ...
                    {type = gailun.TYPES.SPRITE, filename = "res/images/datongzi/counting_panel/dangedi.png", x = 40, y = 65, children = {
                        {type = gailun.TYPES.SPRITE, filename = "res/images/datongzi/counting_panel/5.png", x = 35, y = 70},
                    ...
                    {type = gailun.TYPES.SPRITE, filename = "res/images/datongzi/counting_panel/dangedi.png", x = 130, y = 65, children = {
                        {type = gailun.TYPES.SPRITE, filename = "res/images/datongzi/counting_panel/10.png", x = 35, y = 70},
                    ...
                    {type = gailun.TYPES.SPRITE, filename = "res/images/datongzi/counting_panel/dangedi.png", x = 220, y = 65, children = {
                        {type = gailun.TYPES.SPRITE, filename = "res/images/datongzi/counting_panel/K.png", x = 35, y = 70},
                    ...
                    {type = gailun.TYPES.SPRITE, filename = "res/images/datongzi/counting_panel/add.png", x = 85, y = 65},
                    {type = gailun.TYPES.SPRITE, filename = "res/images/datongzi/counting_panel/add.png", x = 175, y = 65},
