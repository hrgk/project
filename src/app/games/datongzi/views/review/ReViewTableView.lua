local TableView = import("app.games.datongzi.views.game.TableView")
...
tableNodes.normal = {
    ...
    children = {
        {type = TYPES.NODE, var = "nodeTableInfo_", children = {  -- 桌子信息容器
            {type = TYPES.LABEL, var = "viewProgress_", type = TYPES.CUSTOM, class = "app.games.datongzi.views.game.ProgressView", x = display.cx, y = display.cy},
