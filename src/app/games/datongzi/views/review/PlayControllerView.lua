...
local data = {
    type = TYPES.ROOT,
    children = {
        {type = TYPES.SPRITE, filename = "images/replay/control_panel_bg.png", touchEnabled = true, children = {
            {type = TYPES.BUTTON, var = "buttonFastBack_", autoScale = 0.9, normal = "images/replay/review_fb.png", ppx = 0.14, ppy = 0.5},
            {type = TYPES.BUTTON, var = "buttonPlay_", autoScale = 0.9, normal = "images/replay/review_play.png", ppx = 0.38, ppy = 0.5},
            {type = TYPES.BUTTON, var = "buttonPause_", autoScale = 0.9, normal = "images/replay/review_pause.png", ppx = 0.38, ppy = 0.5},
            {type = TYPES.BUTTON, var = "buttonFastForward_", autoScale = 0.9, normal = "images/replay/review_ff.png", ppx = 0.62, ppy = 0.5},
            {type = TYPES.BUTTON, var = "buttonReturn_", autoScale = 0.9, normal = "images/replay/review_return.png", ppx = 0.86, ppy = 0.5},
            {type = TYPES.LABEL, var = "labelProgress_", options = {text = "", size = 24, color = cc.c4b(255, 255, 255, 255), font = DEFAULT_FONT}, ppx = 0.5, y = 268 ,ap = {0.5,0.5}},
        }},
    }
}
...
function PlayControllerView:onFastBackClicked_(event)
    local currPress = os.time()
    if currPress - self.lastPress_ > 1 then
        self.lastPress_ = currPress
