...
nodes.bg = {
    type = gailun.TYPES.ROOT, children = {
        ...
        --{type = gailun.TYPES.SPRITE, filename = "res/images/datongzi/game/shangtiao.png", x = display.cx, y = display.cy + 350, scale = display.width / DESIGN_WIDTH},
        {type = TYPES.SPRITE, filename = "res/images/datongzi/game/logo.png", px = 0.5, py = 0.7},
...
nodes.menuLayerTree = {
    type = gailun.TYPES.ROOT, children = {
        ...
        {type = TYPES.BUTTON, var = "buttonWanFa_", normal = "res/images/game/bt_gz.png", autoScale = 0.9, x = display.right -200, y = display.top - 112},
