...
local nodes = {type = TYPES.ROOT,
        children = {
        {type = TYPES.SPRITE, filename = "images/zj_bj.png", ppx = 0.5, ppy = 0.5, ap = {0.5, 0.5},},
        {type = TYPES.SPRITE, filename = "images/zj_bsd.png", var = "rankBg1_", ppx = 0.5, ppy = 0.38, ap = {0.5, 0.5},},
        ...
        {type = TYPES.SPRITE, var = "titlePng_", filename = "images/hall/ranscore.png", ppx = 0.5, ppy = 0.81, ap = {0.5, 0.5}},
        {type = TYPES.BUTTON, var = "buttonLookOther_", autoScale = 0.9, normal = "images/hall/lookother.png", options = {}, ppx = 0.88, ppy = 0.925, visible = true},
...
function ZhanJiScene:onHttpGetRoomRoundsSuccess_(data)
    ...
    -- self.infoList_:setPositionY(30)
end
