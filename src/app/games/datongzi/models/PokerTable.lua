...
PokerTable.schema["cardCount"] = {"number", 0} --牌数量
...
function PokerTable:setConfigData(data)
    ...
    self.tableConfig_ = {
        ...
        tail3WithCard = ruleDetails.tail3WithCard,
    }
...
function PokerTable:getCardCount()
    dump(self.tableConfig_, self.cardCount_)
    return self.tableConfig_.cardCount
end
