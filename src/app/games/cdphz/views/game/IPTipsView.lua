...
local nodes = {
	...
	{type = TYPES.NODE, var = "ipTipLayer_", size = {display.width, display.height}, ap = {0, 0}, children = {
		{type = TYPES.SPRITE, filename = "res/images/sz_bg.png", scale9 = true, size = {740, 500}, capInsets = cc.rect(340, 150, 1, 1), x = display.cx, y = display.cy, children = {
            ...
            {type = TYPES.SPRITE, var = "ts_word_", filename = "res/images/game/tsk_fzzb.png", ppx = 0.5, ppy = 0.95, ap = {0.5, 0.5}},
			...
			{type = TYPES.BUTTON, var = "buttonQuit_", normal = "res/images/game/quit_room.png", y = 90, x = 240,},
			{type = TYPES.BUTTON, var = "buttonContinue_", normal = "res/images/game/button_continue_game.png", y = 90, x = 510},
		}},
	}
	}}
}
