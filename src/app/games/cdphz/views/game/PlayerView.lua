...
local PlayAnim = require("app.games.cdphz.views.PlayAnim")
...
function PlayerView:initPosByIndex_()
    ...
    local huxiX = HUXI_X
    if self.index_ == TABLE_DIRECTION.BOTTOM or self.index_ == TABLE_DIRECTION.LEFT then
...
function PlayerView:calcWaiPaiPos_(index, offset)
    if TABLE_DIRECTION.BOTTOM == self.index_ then
