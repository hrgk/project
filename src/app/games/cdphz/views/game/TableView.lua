...
local testData = require("app.games.cdphz.data.test")

local HuangAnim = require("app.games.cdphz.views.HuangAnim")
...
tableNodes.normal = {
    ...
    children = {
        ...
        {type = TYPES.CUSTOM, var = "directorController_", class = "app.games.cdphz.controllers.DirectorController"},
        ...
        {type = TYPES.CUSTOM, var = "progressView_", class = "app.games.cdphz.views.game.ProgressView"}, -- 主玩家的手牌容器，需要最高等级的显示
...
local PuPingCardList = import("app.games.cdphz.views.pingPu.PaperCardList")
local ShanXingCardList = import("app.games.cdphz.views.shanXing.PaperCardList")
-- "app.games.cdphz.views.pingPu.PaperCardList"
local paiXingList = {}
...
function TableView:ctor(table)
    ...
    local debugView = DebugView.new(COMMANDS.CDPHZ_DEBUG_CONFIG_CARD, testData)
