...
local RoundOverMingTangItem = import("app.games.cdphz.views.game.RoundOverMingTangItem")
local RoundOverKan = import("app.games.cdphz.views.game.RoundOverKan")
...
function CDPHZRoundOver:loaderCsb()
    self.csbNode_ = cc.uiloader:load("views/games/cdphz/RoundOver.csb"):addTo(self)
