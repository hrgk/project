...
PokerTable.SHOW_TUO_GUAN_ANIMA = "SHOW_TUO_GUAN_ANIMA"
PokerTable.SHOW_TUO_GUAN_BTN = "SHOW_TUO_GUAN_BTN"
function PokerTable:ctor()
    PokerTable.super.ctor(self)
end

function PokerTable:setTuoGuan(bool)
    self.tuoGuan_ = bool
end

function PokerTable:isTuoGuan()
    return self.tuoGuan_
end

function PokerTable:showTuoGuanAnima(bool)
    local event = {name = PokerTable.SHOW_TUO_GUAN_ANIMA, bool = bool}
    self:dispatchEvent(event)
end

function PokerTable:showTuoGuanBtn(bool)
    local event = {name = PokerTable.SHOW_TUO_GUAN_BTN, bool = bool}
    self:dispatchEvent(event)
end
