...
local nodes = {
    ...
    {type = TYPES.NODE, var = "ipTipLayer_", size = {display.width, display.height}, color = cc.c4b(0, 0, 0, 99), ap = {0, 0}, children = {
            ...
            {type = TYPES.SPRITE, var = "locationbg_", filename = "res/images/locationbg.png", scale9 = true, size = {900, 650}, capInsets = cc.rect(340, 50, 1, 1), x = display.cx, y = display.cy , children = {
            {type = TYPES.SPRITE, var = "sanjiao_", filename = "res/images/sanjiao.png", ppx = 0.5, ppy = 0.65, ap = {0.5, 0.5}},
            ...
            {type = TYPES.LABEL, var = "labelusername3_", options = {text = "3333", 
                size = 26, font = DEFAULT_FONT, color = cc.c4b(77, 36, 21, 255)}, ppx = 0.07, ppy = 0.9, ap = {0, 0.5}},
            {type = TYPES.CUSTOM, var = "avatar3_", class = "app.views.AvatarView", ppx = 0.15, ppy = 0.8, ap = {0.5, 0.5}},
            {type = TYPES.LABEL, var = "labeluserid3_", options = {text = "3333", 
                size = 26, font = DEFAULT_FONT, color = cc.c4b(77, 36, 21, 255)}, ppx = 0.07, ppy = 0.7, ap = {0, 0.5}},

            {type = TYPES.LABEL, var = "labelusername2_", options = {text = "2222", 
                size = 26, font = DEFAULT_FONT, color = cc.c4b(77, 36, 21, 255)}, ppx = 0.93, ppy = 0.9, ap = {1, 0.5}},
            {type = TYPES.CUSTOM, var = "avatar2_", class = "app.views.AvatarView", ppx = 0.85, ppy = 0.8, ap = {0.5, 0.5}},
            {type = TYPES.LABEL, var = "labeluserid2_", options = {text = "2222", 
                size = 26, font = DEFAULT_FONT, color = cc.c4b(77, 36, 21, 255)}, ppx = 0.93, ppy = 0.7, ap = {1, 0.5}},

            {type = TYPES.LABEL, var = "labelusername1_", options = {text = "1111", 
                size = 26, font = DEFAULT_FONT, color = cc.c4b(77, 36, 21, 255)}, ppx = 0.5, ppy = 0.5, ap = {0.5, 0.5}},
            {type = TYPES.CUSTOM, var = "avatar1_", class = "app.views.AvatarView", ppx = 0.5, ppy = 0.4, ap = {0.5, 0.5}},
            {type = TYPES.LABEL, var = "labeluserid1_", options = {text = "1111", 
                size = 26, font = DEFAULT_FONT, color = cc.c4b(77, 36, 21, 255)}, ppx = 0.5, ppy = 0.3, ap = {0.5, 0.5}},

            {type = TYPES.LABEL, var = "juli3_", options = {text = "333米", 
                size = 26, font = DEFAULT_FONT, color = cc.c4b(77, 36, 21, 255)}, ppx = 0.5, ppy = 0.8, ap = {0.5, 0.5}},
            {type = TYPES.LABEL, var = "juli2_", options = {text = "222米", 
                size = 26, font = DEFAULT_FONT, color = cc.c4b(77, 36, 21, 255)}, ppx = 0.35, ppy = 0.63, ap = {0.5, 0.5}},
            {type = TYPES.LABEL, var = "juli1_", options = {text = "111米", 
                size = 26, font = DEFAULT_FONT, color = cc.c4b(77, 36, 21, 255)}, ppx = 0.65, ppy = 0.63, ap = {0.5, 0.5}},
            {type = TYPES.BUTTON, var = "buttonQuit_", autoScale = 0.9, normal = "res/images/tianzha/game/quit_room.png", y = 150, x = 220,},
            {type = TYPES.BUTTON, var = "buttonContinue_", autoScale = 0.9, normal = "res/images/tianzha/game/button_continue_game.png", y = 150, x = 680},
...
function LocationTipsView:ctor(params,data, isKaiju)
    ...
    if not dataCenter:getPokerTable():isOwner(dataCenter:getHostPlayer():getUid()) then
        self.buttonQuit_:setButtonImage('pressed', "res/images/tianzha/game/quit_room.png")
        self.buttonQuit_:setButtonImage('normal', "res/images/tianzha/game/quit_room.png")
    else
        self.buttonQuit_:setButtonImage('pressed', "res/images/tianzha/game/button_dismiss2.png")
        self.buttonQuit_:setButtonImage('normal', "res/images/tianzha/game/button_dismiss2.png")
    end
    if not isKaiju then
...
function LocationTipsView:onQuitClicked_(event)
    ...
    if not dataCenter:getPokerTable():isOwner(dataCenter:getHostPlayer():getUid()) then
        ...
        local obj = {}
        obj.roomID = dataCenter:getPokerTable():getTid()
        dataCenter:sendOverSocket(COMMANDS.ZMZ_OWNER_DISMISS, obj)
    end
    self:doClose()
end
