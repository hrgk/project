...
local Nodes = {
    ...
    children = {
        {type = TYPES.NODE, var = "nodeDirection_", children = {
            {type = TYPES.SPRITE, var = "alarmClock_", filename = "res/images/tianzha/game/alarm_clock.png"},
        }},
        {type = TYPES.LABEL_ATLAS, var = "labelSeconds_", filename = "res/images/tianzha/fonts/game_destoryroom.png", options = {text="", w = 18, h = 32, startChar = "0"}, ap = {0.5, 0.5}},
    },
}
