...
{type = TYPES.SPRITE, filename = "res/images/sz_bg.png", var = "rootLayer_", x = display.cx, y = display.cy,scale9 = true, size = {630, 370}, capInsets = cc.rect(100, 100, 100, 100),
            children = {
                ...
                {type = gailun.TYPES.BUTTON, var = "buttonCopy_1_", autoScale = 0.9, normal = "res/images/hall/tipcopybutton.png", 
                    options = {}, ppx = 0.82, ppy = 0.6 },
                {type = gailun.TYPES.BUTTON, var = "buttonCopy_2_", autoScale = 0.9, normal = "res/images/hall/tipcopybutton.png", 
                    options = {}, ppx = 0.82, ppy = 0.4 },
                {type = gailun.TYPES.BUTTON, var = "buttonCopy_3_", autoScale = 0.9, normal = "res/images/hall/tipcopybutton.png", 
