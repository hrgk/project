...
local nodes = {
    type = TYPES.ROOT,
    children = {
        {type = TYPES.SPRITE, filename = "images/duihua/juxing.png", x = display.cx, y = display.bottom + 150, scale9 = true, size = {1280, 300}, capInsets = cc.rect(10, 10, 10, 10), children = {
