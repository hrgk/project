...
local nodes = {
    ...
    {type = TYPES.NODE, var = "mainLayer_", size = {display.width, display.height}, ap = {0, 0}, children = {
        {type = TYPES.SPRITE, filename = "images/sz_bg.png",  var = "rootLayer_", x = display.cx, y = display.cy, scale9 = true, size = {700, 480}, capInsets = cc.rect(100, 100, 100, 100),
            children = {
                ...
                {type = TYPES.BUTTON, var = "buttonQuitGame_", autoScale = 0.9, normal = "images/hall/settingQuit.png",
...
function SettingView:onMusicClicked_(event)
    ...
    if not isPlay then
        ...
        gameConfig:set(CONFIG_MUSIC_VOLUME, 100)
