...
function GameOverView:onShareClicked_(event)
    ...
    display.getRunningScene():gameShareWeiXin("红中麻将","",callback,display.getRunningScene():getTable():getTid(),selfData:getUid(), self.recordId)
end
...
function GameOverView:onShareImageClicked_()
    ...
    display.captureScreen(function (bSuc, filePath)
        ...
        display.getRunningScene():shareImage(2,"红中麻将","",0, callback, filePath)
