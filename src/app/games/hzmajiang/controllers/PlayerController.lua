...
function PlayerController:reSetCardPos(...)
    if not self.player_ then
        return
    end
    self.player_:reSetCardPos(...)
end
...
function PlayerController:setIndex(index,flag)
    self.index_ = index
    if self.player_ then
        self.player_:setIndex(index,flag)
    else
...
function PlayerController:onGangLock_(...)
    if not self.player_ then
        return
    end
