...
function PlayerController:sitDown(data)
    ...
    self.number_ = data.playerCount 
    self.player_:setIndex(self.index_)
    self.view_:setIndex(self.index_,self.number_)
...
function PlayerController:doSiShou(...)
    if not self.player_ then
        return
    end
    self.player_:doSiShou(...)
end
