...
nodes.bg = {
    type = gailun.TYPES.ROOT, children = {
        ...
        {type = gailun.TYPES.SPRITE, var = "gameNameLogn_",filename = "res/images/yzchz/logo2.png", x = display.cx, y = display.cy+120, scale = display.width / DESIGN_WIDTH},
    },
}
...
nodes.menuLayerTree = {
    type = gailun.TYPES.ROOT, children = {
        ...
        {type = TYPES.BUTTON, var = "buttonHuaYu_", normal = "res/images/game/huayu.png", autoScale = 0.9, x = display.right - 50, y = display.bottom + 260,},
        {type = TYPES.CUSTOM, var = "buttonVoiceView_", class = "app.views.game.VoiceRecordView", px = 0.5, py = 0.65},
        -- {type = TYPES.BUTTON, var = "buttonToWechat_", normal = "res/images/towechat.png", autoScale = 0.9, x =  50, y = display.cy - 30,},
        {type = TYPES.CUSTOM, var = "buttonVoice_", class = "app.views.game.VoiceChatButton", x = display.right - 50, y = display.bottom + 190 },
        {type = TYPES.BUTTON, var = "buttonOK_", normal = "res/images/common/btn_queding.png", x = display.cx, y = 100, autoScale = 0.9},

        {type = TYPES.BUTTON, var = "buttonReconnect_", normal = "res/images/game/refresh.png", autoScale = 0.9, x = display.right - 50, y = display.bottom + 120,},
        {type = TYPES.BUTTON, var = "buttonTiPai_", normal = "res/images/paohuzi/game/btn_tiPai.png", autoScale = 0.9,  x = display.right - 100, y = display.bottom+45,},
