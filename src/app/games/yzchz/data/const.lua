...
SI_QI_HU = 18  -- # 四七胡
SAN_TI_WU_KAN = 19  -- # 3提5砍
PING_HU = 100  -- # 平胡
WANG_DIAO = 19 --#王钓
WANG_DIAO_WANG = 20 --#王钓王
WANG_CHUANG = 21 --#王闯
WANG_CHUANG_WANG = 22 --#王闯王
WANG_ZHA = 23 --#王炸
WANG_ZHA_WANG = 24 --#王炸王

CONSUMER_HANDCARDS = "CONSUMER_HANDCARDS"
-- 渠道配置信息，由后台来总控制这些变量来控制各种开关和环境信息

TABLE_YZCHZ_DIRECTION = {  -- 客户端方向定义，逆时针方向
    BOTTOM = 1,
    RIGHT = 2,
    LEFT = 3,
}
...
SMALL_CARD_WIDTH = 30 * 1.2
SMALL_CARD_HEIGHT = 35
...
ANIM_YZCHZ_LIST = {
    qing = "res/images/paohuzi/ani/qing.png",
    genxing = "res/images/paohuzi/ani/genxing.png",
    fanxing = "res/images/paohuzi/ani/fanxing.png",
    chouxiao = "res/images/paohuzi/ani/chouxiao.png",
    xiao = "res/images/paohuzi/ani/xiao.png",
    sishou = "res/images/paohuzi/ani/sishou.png",
