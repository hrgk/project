...
function HuAnim:ctor()
    ...
    local long_guang = display.newSprite("res/images/paohuzi/ani/longguang.png"):addTo(self)
    local light1 = BaseAlgorithm.createPingPongLight(seconds1, 1.01, 0.99)
    long_guang:runAction(light1)
    display.newSprite("res/images/paohuzi/ani/long.png"):addTo(self)

    local hu_guang = display.newSprite("res/images/paohuzi/ani/huguang.png"):addTo(self):pos(-10, 20)
    hu_guang:setVisible(false)

    local hu = display.newSprite("res/images/paohuzi/ani/hu.png"):addTo(self):pos(-10, 20)
    hu:pos(-20, 80)
    hu:setScale(2.5)
