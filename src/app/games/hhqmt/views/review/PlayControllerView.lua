...
local data = {
    ...
    children = {
        {type = TYPES.NODE, children = {
            ...
            {type = TYPES.BUTTON, var = "buttonPlay_", autoScale = 0.9, normal = "res/images/replay/review_play.png", x = -60, y = -40},
            {type = TYPES.BUTTON, var = "buttonPause_", autoScale = 0.9, normal = "res/images/replay/review_pause.png", x =  -60, y = -40},
            --{type = TYPES.BUTTON, var = "buttonFastForward_", autoScale = 0.9, normal = "res/images/replay/review_ff.png", ppx = 0.62, ppy = 0.5},
            {type = TYPES.BUTTON, var = "buttonReturn_", autoScale = 0.9, normal = "res/images/replay/review_return.png", x = 60, y = -40},

            {type = TYPES.LABEL, var = "labelProgress_", options = {text = "", size = 24, color = cc.c4b(255, 255, 255, 255), font = DEFAULT_FONT}, ppx = 0.5, y = 120 ,ap = {0.5,0.5}},
        }, y = 0},
    }
}
