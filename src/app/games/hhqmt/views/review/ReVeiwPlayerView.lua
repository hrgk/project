local PlayerView = import("app.games.hhqmt.views.game.PlayerView")
    ...
    children = {
        ...
        {type = TYPES.SPRITE, var = "nodehuxi",children = { 
            {type = TYPES.NODE, var = "huxiBg_", filename = "res/images/game/tablehuxibg.png", scale9 = true, size = {190, 50}, children = {
                ...
                {type = TYPES.LABEL_ATLAS, var = "labelHuxi_", filename = "fonts/game_score.png", options = {text="0", w = 14, h = 35, startChar = "-"}, ppy = 0.38, ppx = 0.425, ap = {0, 0.5}},
            }},  
        }},  -- 吃碰容器
...
function ReVeiwPlayerView:updatePaperCardListPos_()
    if self.index_ == TABLE_HHQMT_DIRECTION.LEFT then
