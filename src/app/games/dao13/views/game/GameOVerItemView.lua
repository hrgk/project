...
function GameOVerItemView:setNode(csbNode)
    ...
    self.sbCount_:setString(self.data_.loseCount)
    self.pjCount_:setString(self.data_.equalCount)
    self.hongCount_:setString(self.data_.hongCount)
    self.heiCount_:setString(self.data_.heiCount)
    self.tspxCount_:setString(self.data_.specialCount)
