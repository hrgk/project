...
local nodes = {type = TYPES.ROOT, children = {
                ...
                {type = TYPES.BUTTON, var = "buttonLook_", autoScale = 0.9, normal = "res/images/hall/ranklook.png", options = {}, ppx = 0.83, ppy = 0.1 },
                {type = TYPES.BUTTON, var = "buttonShare_", autoScale = 0.9, normal = "res/images/hall/zj_fx_btn.png", options = {}, ppx = 0.7, ppy = 0.1 },    
                {type = TYPES.SPRITE, filename = "res/images/xuxian1.png", ppx = 0.5, ppy = -0.25},
            }   
        },
    }
}
