...
local nodes = {
    type = TYPES.ROOT, children = {
        ...
        {type = TYPES.SPRITE, filename = "res/images/sz_bg.png", x = display.cx, y = display.cy,scale9 = true, size = {1200, 630}, capInsets = cc.rect(100, 100, 100, 100)},
        -- {type = TYPES.SPRITE, filename = "res/images/chuangjiandi.png", ppx = 0.5, ppy = 0.5, ap = {0.5, 0.5}},
        {type = TYPES.SPRITE, filename = "res/images/common/grxx_title.png", ppx = 0.5, ppy = 0.93},
        {type = TYPES.SPRITE, filename = "res/images/hall/guiz.png", ppx = 0.5, ppy = 0.935, ap = {0.5, 0.5}},
...
function TianZhaHelpView:initScrollView_()
    local sprite = display.newSprite("res/images/wanfaimage.png")
