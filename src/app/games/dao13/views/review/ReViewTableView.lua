local TableView = import("app.games.dao13.views.game.TableView")
...
tableNodes.normal = {
    ...
    children = {
        {type = TYPES.NODE, var = "nodeTableInfo_", children = {  -- 桌子信息容器
            {type = TYPES.LABEL, var = "viewProgress_", type = TYPES.CUSTOM, class = "app.games.dao13.views.game.ProgressView", x = display.cx, y = display.cy},
        ...
        {type = TYPES.CUSTOM, var = "directorController_", class = "app.games.dao13.controllers.DirectorController"},
