...
function GameOverView:onShareClicked_(event)
    ...
    display.getRunningScene():gameShareWeiXin("宁夏划水","",callback,display.getRunningScene():getTable():getTid(),selfData:getUid(), self.recordId)
end
...
function GameOverView:onShareImageClicked_()
    ...
    display.captureScreen(function (bSuc, filePath)
        ...
        display.getRunningScene():shareImage(2,"宁夏划水","",0, callback, filePath)
