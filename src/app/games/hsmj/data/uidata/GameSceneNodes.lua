...
nodes.bg = {
    type = gailun.TYPES.ROOT, children = {
        {type = gailun.TYPES.SPRITE, var = "bgSprite_", filename = "res/images/majiang/tableBg/3d/1.png", x = display.cx, y = display.cy, scale = display.width / DESIGN_WIDTH},
        {type = TYPES.SPRITE, var = "title_", filename = "res/images/majiang/logo_hs_pt.png", px = 0.5, py = 0.68},
    },
}
