...
local nodeTree = {
    ...
    children = {
        {type = TYPES.LAYER, children = {
            ...
            {type = TYPES.BUTTON, var = "buttonGang_", normal = "res/images/majiang/game/button_shai.png", px = actionPosList[3][1], py = actionPosList[3][2]},
            ...
            {type = TYPES.BUTTON, var = "buttonBu_", normal = "res/images/majiang/game/button_gang.png", px = actionPosList[6][1], py = actionPosList[6][2]},
        }},
...
function ActionButtonsView:showOperates(operates, operatesInfo, isShowPass)
    ...
    if isShowPass == false or (1 == #buttons and buttons[1] == self.buttonPass_) then
        table.removebyvalue(buttons, self.buttonPass_)
        table.insert(hides, self.buttonPass_)
    end
