...
tableNodes.normal = {
    ...
    children = {
        {type = TYPES.NODE, var = "nodeTableInfo_", children = {  -- 桌子信息容器
            ...
            {type = TYPES.CUSTOM, var = "directorController_", class = "app.games.mmmj.controllers.DirectorController", px = 0.5, py = display.cy + 30 * display.width / DESIGN_WIDTH},
        ...
        {type = TYPES.LABEL, var = "viewProgress_", type = TYPES.CUSTOM, class = "app.games.mmmj.views.game.ProgressView", x = display.cx, y = display.cy + 35},
        {type = TYPES.NODE, var = "nodePublicPokers_"}, --公共牌容器
        {type = TYPES.CUSTOM, var = "focusArrow_", class = "app.games.mmmj.views.game.FocusArrowView", px = 0.2, py = 0.5, visible = false},
        ...
        {type = TYPES.CUSTOM, var = "tingView_", class = "app.games.mmmj.views.game.TingView", visible = true},
    }
}
...
local logoNames =  {
                        ...
                        [GAME_MMMJ] = "res/images/majiang/logo_cs.png",
                    }
...
function TableView:ctor(table, tableController)
    ...
    local debugView = DebugView.new(COMMANDS.MMMJ_DEBUG_CONFIG_CARD, testData)
...
function TableView:onChuiClicked_(event)
    local data = {chui = 2}
    dataCenter:sendOverSocket(COMMANDS.MMMJ_PLAYER_CHUI, data)
end

function TableView:onHaiDiClicked_(event)
    local data = {isNeed = 1}
    print("onHaiDiClicked_(event)")
    dataCenter:sendOverSocket(COMMANDS.MMMJ_HAI_DI, data)
end
...
function TableView:onBanBanHuClick_(event)
    ...
    local data = {isNeed = 0}
    dataCenter:sendOverSocket(COMMANDS.MMMJ_SHOW_BANBANHU, data)
