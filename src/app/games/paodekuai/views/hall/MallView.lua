...
local nodes = {
    ...
    {type = TYPES.NODE, var = "mainLayer_", size = {display.width, display.height}, ap = {0, 0}, children = {
        {type = TYPES.SPRITE, filename = "res/images/sz_bg.png", var = "rootLayer_", x = display.cx, y = display.cy,scale9 = true, size = {1000, 540}, capInsets = cc.rect(100, 100, 100, 100),
            children = {
                {type = TYPES.SPRITE, filename = "res/images/common/grxx_title.png", ppx = 0.51, ppy = 0.98, ap = {0.5, 0.5}},
                {type = TYPES.SPRITE, filename = "res/images/mall/mai1.png", ppx = 0.25, ppy = 0.55, ap = {0.5, 0.5}},
                {type = TYPES.SPRITE, filename = "res/images/mall/mai2.png", ppx = 0.5, ppy = 0.55, ap = {0.5, 0.5}},
                {type = TYPES.SPRITE, filename = "res/images/mall/mai3.png", ppx = 0.75, ppy = 0.55, ap = {0.5, 0.5}},

                {type = TYPES.SPRITE, filename = "res/images/mall/shangcheng.png", ppx = 0.5, ppy = 0.98, ap = {0.5, 0.5}},
                
                {type = TYPES.BUTTON, var = "buttonClosed_", autoScale = 0.9, normal = "res/images/common/closebutton.png", 
                    options = {}, ppx = 0.97, ppy = 0.95 },
                {type = TYPES.BUTTON, var = "buttonQueDing1_", autoScale = 0.9, normal = "res/images/mall/goumai.png", 
                    options = {}, ppx = 0.25, ppy = 0.2 },
                {type = TYPES.BUTTON, var = "buttonQueDing2_", autoScale = 0.9, normal = "res/images/mall/goumai.png", 
                    options = {}, ppx = 0.5, ppy = 0.2 },
                {type = TYPES.BUTTON, var = "buttonQueDing3_", autoScale = 0.9, normal = "res/images/mall/goumai.png", 
