...
local nodeBg = {
        type = TYPES.ROOT, children = {
            {type = TYPES.SPRITE, filename = "res/images/hall/msgbg.png", var = "bg_", scale9 = true, size = {display.width * 0.97 * WIDTH_SCALE, display.height * 0.82 * HEIGHT_SCALE}, ppx = 0.5, ppy = 0.43, ap = {0.5, 0.5}},
        }
    }

local nodeTitle = {
    type = TYPES.ROOT, children = {
        {type = TYPES.SPRITE, filename = "res/images/hall/lookbackbg.png", var = "imgbg_", children = {
            {type = TYPES.SPRITE, filename = "res/images/hall/hall_bg9.png", scale9 = true, size = {display.width * 0.88 * WIDTH_SCALE, display.height /14 * HEIGHT_SCALE} , ppx = 0.5, ppy = 0.93},
            {type = TYPES.LABEL, options = {text = "序号", size = 28, color = cc.c4b(77, 36, 21, 0), font = DEFAULT_FONT}, ppx = 0.04, ppy = 0.93 ,ap = {0.5 ,0.5}},
            {type = TYPES.SPRITE, filename = "res/images/hall/rankfgx.png", ppx = 0.085, ppy = 0.93 ,scale9 = true, size = {2, 40}},

            {type = TYPES.LABEL, options = {text = "对战时间", size = 28, color = cc.c4b(77, 36, 21, 0), font = DEFAULT_FONT}, ppx = 0.16, ppy = 0.93 ,ap = {0.5, 0.5}},
            {type = TYPES.SPRITE, filename = "res/images/hall/rankfgx.png", ppx = 0.24, ppy = 0.93 ,scale9 = true, size = {2, 40}},
            ...
            {type = TYPES.SPRITE, filename = "res/images/hall/rankfgx.png", ppx = 0.42, ppy = 0.93 ,scale9 = true, size = {2, 40}},
            ...
            {type = TYPES.SPRITE, filename = "res/images/hall/rankfgx.png", ppx = 0.6, ppy = 0.93 ,scale9 = true, size = {2, 40}},
            ...
            {type = TYPES.SPRITE, filename = "res/images/hall/rankfgx.png", ppx = 0.78, ppy = 0.93 ,scale9 = true, size = {2, 40}},
...
local nodeItem = {
    type = TYPES.ROOT, children = {
        {type = TYPES.SPRITE, filename = "res/images/hall/hall_bg29.png", scale9 = true, size = {display.width * 0.88 * WIDTH_SCALE, display.height /10 * HEIGHT_SCALE} , ppx = 0.5, ppy = 0.63, children = {
