...
function PlayerController:mingPai(...)
    if not self.player_ then
        return
    end
    return self.player_:mingPai(...)
end
...
function PlayerController:setCallDealer(...)
    if not self.player_ then
        return
    end
    return self.player_:setCallDealer(...)
end

function PlayerController:getCallDealer()
    if not self.player_ then
        return
    end
    return self.player_:getCallDealer()
end
