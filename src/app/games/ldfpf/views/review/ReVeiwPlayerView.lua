local PlayerView = import("app.games.ldfpf.views.game.PlayerView")
...
local nodeData = {
    ...
    children = {
        {type = TYPES.NODE, var = "nodePlayer_", children = {  -- 玩家基本数据的对象
            ...
            -- }},
            {type = TYPES.LABEL, var = "scoreName_", options = {text="积分:", size=17, font = DEFAULT_FONT, align=cc.TEXT_ALIGNMENT_CENTER, color=cc.c3b(255, 255, 255)}, y = -60, x = 0, ap = {1, 0.5}},
...
function ReVeiwPlayerView:initPosByIndex_()
    ReVeiwPlayerView.super.reViewinitPosByIndex_(self)
