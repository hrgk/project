...
local RoundOverMingTangItem = import("app.games.ldfpf.views.game.RoundOverMingTangItem")
local RoundOverKan = import("app.games.ldfpf.views.game.RoundOverKan")
...
function CDPHZRoundOver:initBg_(winType)
    self.add_:setScale(0.8)
    self.cdd_:setScale(0.8)
    if winType == 2 then
