...
function PaperCardView:showMark(isMo)
	...
	if isMo then
		...
		kuang = display.newSprite("res/images/paohuzi/a_cards/mopai_bj.png"):pos(0, 0):addTo(self)
	else
		local sep =  display.newSprite("res/images/game/chu.png"):pos(0, 0):addTo(self)
		kuang = display.newSprite("res/images/paohuzi/a_cards/chupai_bj.png"):pos(0, 0):addTo(self)
	end
	self:scale(0.65)
end
