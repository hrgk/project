...
function MaJiang2DView:setMaJiangMask()
...
function MaJiang2DView:clearMaJiangMask()
...
function MaJiang2DView:setTingTag(isShow)
    if self.tingTag_ == nil then
        self.tingTag_ = display.newSprite("res/images/majiang/game/tingPaiTagUp.png"):addTo(self):pos(0, 85)
    end
