...
function MaJiangView:setTingTag(isShow)
    if self.tingTag_ == nil then
        self.tingTag_ = display.newSprite("res/images/majiang/game/tingPaiTagUp.png"):addTo(self):pos(-10+5, 80)
    end
...
function MaJiangView:setMaJiangMask()
    self.maJiangMask_ = display.newSprite('#res/images/majiang/majiang/mj_bird_mask.png'):addTo(self):pos(0, 0)
    self.maJiangMask_:scale(1.1)
end

function MaJiangView:clearMaJiangMask()
    if self.maJiangMask_ then
        self.maJiangMask_:removeSelf()
        self.maJiangMask_ = nil
    end
end
