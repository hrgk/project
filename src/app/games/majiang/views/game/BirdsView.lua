...
function BirdsView:createBird_(bird, total, index, birdCount)
    ...
    local ret, birdShunXu, startSeatID = BaseAlgorithm.isBird(bird, isZiMo, isSortBird, isTongPao, jiePaoIndex, fangPaoIndex, playerCount)
    ...
    self:performWithDelay(function ()
        if BaseAlgorithm.isBird(bird, isZiMo, isSortBird, isTongPao, jiePaoIndex, fangPaoIndex, playerCount) then
            self:performWithDelay(function ()
...
function BirdsView:showBirds_(data)
    ...
    if self.data_.oneBrid then
        ...
        for i,v in ipairs(cards) do
            if BaseAlgorithm.isBird(v, isZiMo, isSortBird, isTongPao, jiePaoIndex, fangPaoIndex, data.playerCount) then
                birdCount = birdCount + 1
            end
            self:createBird_(v, #cards, i, birdCount)
        end
