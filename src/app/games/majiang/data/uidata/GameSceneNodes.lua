...
nodes.bg = {
    type = gailun.TYPES.ROOT, children = {
        ...
        {type = TYPES.SPRITE, var = "hzTitle_", filename = "res/images/majiang/logo_hz.png", px = 0.5, py = 0.65},
        {type = TYPES.SPRITE, var = "zmTitle_", filename = "res/images/majiang/logo_zm.png", px = 0.5, py = 0.65},
    },
}
...
nodes.menuLayerTree = {
    type = gailun.TYPES.ROOT, children = {
        ...
        {type = TYPES.BUTTON, var = "buttonInvite_", normal = "res/images/game/button_invite_weixin.png", autoScale = 0.9, x = display.cx, py = display.cy - 100,},
        ...
        {type = TYPES.BUTTON, var = "buttonHuaYu_", normal = "res/images/game/huayu.png", autoScale = 0.9, x = display.right - 50, y = display.cy - 20+20,},
        {type = TYPES.CUSTOM, var = "buttonVoiceView_", class = "app.views.game.VoiceRecordView", px = 0.5, py = 0.65},
        -- {type = TYPES.BUTTON, var = "buttonToWechat_", normal = "res/images/towechat.png", autoScale = 0.9, x = display.width - 50, y = display.height - 150},
        {type = TYPES.CUSTOM, var = "buttonVoice_", class = "app.views.game.VoiceChatButton", x = display.width - 50, y = display.cy - 100+20},
