...
nodes.bg = {
    type = gailun.TYPES.ROOT, children = {
        ...
        {type = TYPES.SPRITE, var = "hzTitle_", filename = "res/images/majiang/logo_hz.png", px = 0.5, py = 0.7},
        {type = TYPES.SPRITE, var = "zmTitle_", filename = "res/images/majiang/logo_zm.png", px = 0.5, py = 0.7},
    },
}
