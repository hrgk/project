...
local nodes = {
    ...
    children = {
        ...
        {type = TYPES.SPRITE, var = "guizetiaoBg_", filename = "res/images/game/guizetiao.png", x = 0, y = 305},
        {type = TYPES.LABEL, var = "labelTableID_", options = {text="", size=20, font = DEFAULT_FONT, color=cc.c3b(124, 229, 114)}, x = 50, y = 305 , ap = {0.5, 0.5}},
        {type = TYPES.LABEL, visible = true, var = "timeLabel_", x = -115, y = 305,options = {text="00:00", size=20, font = DEFAULT_FONT, color=cc.c3b(124, 229, 114)}, ap = {0, 0.5}},
        {type = TYPES.SPRITE, visible = true, var = "batteryLv_", filename = "res/images/game/dianchilv.png", x = 162-330, y = 304, ap = {0, 0.5}},
        {type = TYPES.SPRITE, visible = true, var = "batteryHong_", filename = "res/images/game/dianchihong.png", x = 162-330, y = 304, ap = {0, 0.5}},
        {type = TYPES.SPRITE, visible = true, var = "batteryBg_", filename = "res/images/game/dianchikuang.png", x = 185-330, y = 304},
...
function ProgressView:ctor(table)
    ...
    self.guizetiaoBg_:setScaleX(0.6)
end
