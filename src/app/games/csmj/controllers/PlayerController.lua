local Player = import("app.games.csmj.models.Player")
...
function PlayerController:onEnter()
    ...
    --     -- {COMMANDS.CS_MJ_GOLDCHANGED, handler(self, self.onGoldChanged_)},
    -- }
...
function PlayerController:onActionTanPai(...)
    if not self.player_ then
        return
    end
    return self.player_:onActionTanPai(...)
end
...
function PlayerController:onGangLock(...)
    if not self.player_ then
        return
    end
    return self.player_:onGangLock_(...)
end
...
function PlayerController:resumeTanPai(...)
    if not self.player_ then
        return
    end
    return self.player_:resumeTanPai(...)
end
...
function PlayerController:setPlayer_(player)
    ...
    self.player_.isReview_ = self.isReview_
end
...
function PlayerController:beTurnTo(...)
    if not self.player_ then
        return
    end
    self.player_:beTurnTo(...)
end
...
function PlayerController:onActionBu(data)
    if not self.player_ then
        return
    end
    self.player_:onActionCSMJBu_(data)
end
...
function PlayerController:addAfterGangPai(...)
    if not self.player_ then
        return
    end
    return self.player_:addAfterGangPai(...)
end
...
function PlayerController:setInGangState(...)
    if not self.player_ then
        return
    end
    return self.player_:setInGangState(...)
end

function PlayerController:isInGangState()
    if not self.player_ then
        return
    end
    return self.player_:isInGangState()
end
...
function PlayerController:hidePlayerInfo_(...)
    if not self.player_ then
        return
    end
    return self.player_:hidePlayerInfo_(...)
end
